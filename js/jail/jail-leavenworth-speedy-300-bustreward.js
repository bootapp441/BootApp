document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {        
        ...
        function addAutoBustButton(leavenworthTable) {
            ...
            if (firstRow && !document.querySelector('#autoBustButton300reward')) {
                const newRow = document.createElement('tr'); // Create a new row
                newRow.innerHTML = `
                        <br>
                        <span id="autoBustButton300reward" style="
                            font-size: 7pt; 
                ...
                const button = document.querySelector('#autoBustButton300reward');
            ...
            if (localStorage.getItem('resumeAutoBust300bustreward') === 'true') {
                console.log('Resuming AutoBust after reload...');
                localStorage.removeItem('resumeAutoBust300bustreward'); // Clear the state
                const autoBustButton = document.querySelector('#autoBustButton300reward');
                if (autoBustButton) {
        ...
        function startAutoBust(leavenworthTable) {
            ...
            // captcha check
            if (isCaptchaActive()) { 
                localStorage.setItem('resumeAutoBust300bustreward', 'true'); // Store state to resume AutoBust
            ...
            setTimeout(() => {
                ...
                // Schedule the next AutoBust attempt
                setTimeout(() => startAutoBust(updatedTable), Math.random() * 300 + 300); // 6-14 seconds
