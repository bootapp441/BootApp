document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {
        ...
        function checkSlashOut(callback) {
            ...
            if (slashOutDiv) {
                ...
                if (slashTimer && slashTimer.textContent.trim() === "00:00:00") {
                    ...
                    if (slashReadyButton) {
                        ...
                        setTimeout(callback, Math.random() * 300 + 300); // Delay after Slash Out
                        return;
                    }
                } else {
            ...
            setTimeout(callback, Math.random() * 300 + 300); // Proceed if Slash Out is unavailable
        }
        ...
        function checkCigaretteBust(callback) {
            ...
            if (!quickActionsDiv) {
                ...
                setTimeout(callback, Math.random() * 300 + 300);
                return;
            }
            ...
            if (!quickActionsDiv.classList.contains('open')) {
                ...
                setTimeout(() => checkCigaretteBust(callback), Math.random() * 300 + 300);
                return;
            }
            ...
            if (activeTimer) {
                ...
                setTimeout(callback, Math.random() * 300 + 300); // Delay and proceed to next action
                return;
            }
