document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {        
        ...
        function addAutoBustButton(leavenworthTable) {
            ...
            if (firstRow && !document.querySelector('#autoBustButton100cc')) {
                const newRow = document.createElement('tr'); // Create a new row
                newRow.innerHTML = `
                        <br>
                        <span id="autoBustButton100cc" style="
                            font-size: 7pt; 
                            ...
                            cursor: pointer;
                        ">
                            100 | Cotton Candy mode [user ***/***/*** host]
                        </span>
                `;
                ...
                const button = document.querySelector('#autoBustButton100cc');
            ...
            if (localStorage.getItem('resumeAutoBust100cc') === 'true') {
                console.log('Resuming AutoBust after reload...');
                localStorage.removeItem('resumeAutoBust100cc'); // Clear the state
                const autoBustButton = document.querySelector('#autoBustButton100cc');
                if (autoBustButton) {
        ...
        function startAutoBust(leavenworthTable) {
            ...
            // captcha check
            if (isCaptchaActive()) { 
                localStorage.setItem('autoBustButton100cc', 'true'); // Store state to resume AutoBust
            ...
            setTimeout(() => {
                ...
                // First priority: Check for specific usernames "Player1" or "Playe2"
