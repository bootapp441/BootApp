document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {        
        ...
        function addAutoBustButton(leavenworthTable) {
            ...
            if (firstRow && !document.querySelector('#autoBustButton100')) {
                const newRow = document.createElement('tr'); // Create a new row
                newRow.innerHTML = `
                        <br>
                        <span id="autoBustButton100" style="
                            font-size: 7pt; 
                ...
                const button = document.querySelector('#autoBustButton100');
            ...
            if (localStorage.getItem('resumeAutoBust100') === 'true') {
                console.log('Resuming AutoBust after reload...');
                localStorage.removeItem('resumeAutoBust100'); // Clear the state
                const autoBustButton = document.querySelector('#autoBustButton100');
                if (autoBustButton) {
        ...
        function startAutoBust(leavenworthTable) {
            ...
            // captcha check
            if (isCaptchaActive()) { 
                localStorage.setItem('autoBustButton100', 'true'); // Store state to resume AutoBust
