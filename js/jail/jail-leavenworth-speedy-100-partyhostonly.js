document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {        
        ...
        function addAutoBustButton(leavenworthTable) {
            ...
            if (firstRow && !document.querySelector('#autoBustButton100party')) {
                const newRow = document.createElement('tr'); // Create a new row
                newRow.innerHTML = `
                        <br>
                        <span id="autoBustButton100party" style="
                            font-size: 7pt; 
                ...
                const button = document.querySelector('#autoBustButton100party');
            ...
            if (localStorage.getItem('resumeAutoBust100party') === 'true') {
                console.log('Resuming AutoBust after reload...');
                localStorage.removeItem('resumeAutoBust100party'); // Clear the state
                const autoBustButton = document.querySelector('#autoBustButton100party');
                if (autoBustButton) {
        ...
        function startAutoBust(leavenworthTable) {
            ...
            // captcha check
            if (isCaptchaActive()) { 
                localStorage.setItem('resumeAutoBust100party', 'true'); // Store state to resume AutoBust
