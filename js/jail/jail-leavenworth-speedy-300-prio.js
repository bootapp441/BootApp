document.addEventListener('DOMContentLoaded', function () {
    $(document).ready(function () {        
        ...
        function addAutoBustButton(leavenworthTable) {
            ...
            if (firstRow && !document.querySelector('#autoBustButton300')) {
                const newRow = document.createElement('tr'); // Create a new row
                newRow.innerHTML = `
                        <br>
                        <span id="autoBustButton300" style="
                            font-size: 7pt; 
                ...
                const button = document.querySelector('#autoBustButton300');
            ...
            if (localStorage.getItem('resumeAutoBust300') === 'true') {
                console.log('Resuming AutoBust after reload...');
                localStorage.removeItem('resumeAutoBust300'); // Clear the state
                const autoBustButton = document.querySelector('#autoBustButton300');
                if (autoBustButton) {
        ...
        function startAutoBust(leavenworthTable) {
            ...
            // captcha check
            if (isCaptchaActive()) { 
                localStorage.setItem('resumeAutoBust300', 'true'); // Store state to resume AutoBust
